...
// InternalMultipartInitResponse defines model for InternalMultipartInitResponse.
...
// InternalMultipartUploadResponse defines model for InternalMultipartUploadResponse.
...
// InternalUploadBlankResponse defines model for InternalUploadBlankResponse.
...
// InternalUploadBulkResponse defines model for InternalUploadBulkResponse.
...
func (siw *ServerInterfaceWrapper) InternalDownload(c fiber.Ctx) error {
	...
	err = runtime.BindQueryParameter("form", true, false, "redirect", query, &params.Redirect)
	if err != nil {
	...
	err = runtime.BindQueryParameter("form", true, false, "expires_in", query, &params.ExpiresIn)
	if err != nil {
...
func (siw *ServerInterfaceWrapper) InternalDownloadPart(c fiber.Ctx) error {
	...
	if paramValue := c.Query("start"); paramValue != "" {
		...
		err = fmt.Errorf("Query argument start is required, but not found")
		c.Status(fiber.StatusBadRequest).JSON(err)
		return err
	}

	err = runtime.BindQueryParameter("form", true, true, "start", query, &params.Start)
	if err != nil {
	...
	if paramValue := c.Query("end"); paramValue != "" {
		...
		err = fmt.Errorf("Query argument end is required, but not found")
		c.Status(fiber.StatusBadRequest).JSON(err)
		return err
	}

	err = runtime.BindQueryParameter("form", true, true, "end", query, &params.End)
	if err != nil {
...
func (siw *ServerInterfaceWrapper) InternalUploadURL(c fiber.Ctx) error {
	...
	err = runtime.BindQueryParameter("form", true, false, "bucket", query, &params.Bucket)
	if err != nil {
	...
	err = runtime.BindQueryParameter("form", true, false, "file_name", query, &params.FileName)
	if err != nil {
...
func (siw *ServerInterfaceWrapper) InternalDeleteByQuery(c fiber.Ctx) error {
	...
	err = runtime.BindQueryParameter("form", true, false, "authz", query, &params.Authz)
	if err != nil {
	...
	err = runtime.BindQueryParameter("form", true, false, "organization", query, &params.Organization)
	if err != nil {
	...
	err = runtime.BindQueryParameter("form", true, false, "program", query, &params.Program)
	if err != nil {
	...
	err = runtime.BindQueryParameter("form", true, false, "hash", query, &params.Hash)
	if err != nil {
	...
	err = runtime.BindQueryParameter("form", true, false, "hash_type", query, &params.HashType)
	if err != nil {
...
type InternalMultipartInit200JSONResponse InternalMultipartInitResponse
...
type InternalMultipartUpload200JSONResponse InternalMultipartUploadResponse
...
type InternalUploadBlank201JSONResponse InternalUploadBlankResponse
...
type InternalUploadBulk200JSONResponse InternalUploadBulkResponse
...
type InternalUploadBulk207JSONResponse InternalUploadBulkResponse
