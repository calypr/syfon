...
func postgresAccessGrantByID(ctx context.Context, tx *sql.Tx, grantID string) (models.TransferAttributionEvent, bool, error) {
	...
	err := tx.QueryRowContext(ctx, `
		...
		WHERE access_grant_id = $1 OR event_id = $1
...
func postgresAccessGrantCandidates(ctx context.Context, tx *sql.Tx, ev models.ProviderTransferEvent) ([]models.TransferAttributionEvent, error) {
