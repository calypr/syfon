...
func (c *bucketCatalog) credentialIDForAccessMethod(method objects.AccessMethod, creds []models.S3Credential) (string, bool) {
...
func (c *bucketCatalog) bucketForAccessMethod(method objects.AccessMethod, creds []models.S3Credential) (string, bool) {
