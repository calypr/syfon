...
| Change route behavior, auth, middleware, or validation logic only | `cmd/server`, `internal/httpapi/*`, `internal/access/*` | No regen needed | These are handwritten runtime concerns, not generated contracts. |
