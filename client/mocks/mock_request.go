...
// Source: github.com/calypr/syfon/client/request (interfaces: RequestInterface)
//
// Generated by this command:
//
//	mockgen -destination=../mocks/mock_request.go -package=mocks github.com/calypr/syfon/client/request RequestInterface
//
