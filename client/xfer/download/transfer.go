...
func DownloadToPathWithOptions(
	...
	downloader := &engine.GenericDownloader{Backend: bk}
...
func DownloadSingleWithProgress(ctx context.Context, dc Resolver, bk transfer.Backend, guid, downloadPath, filenameFormat string) error {
	logger := bk.Logger()
